...
| **Linux Kernel — `arch/arm64/kernel/entry.S`** | https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/arch/arm64/kernel/entry.S | Production-grade exception entry/exit. Don't copy-paste, but see *what* Linux saves and restores. |
